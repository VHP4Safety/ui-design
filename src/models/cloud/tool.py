...
class Method(BaseModel):
    ...
    description: Optional[str] = Field(None, alias="method_description_content")

    # Upstream issue-template fields (new-tool-method-entry.yml)
    data_producer: Optional[str] = Field(None, alias="data_producer_content")
    sop: Optional[str] = Field(None, alias="available_sop_or_protocol_content")
    vendor: Optional[str] = Field(None, alias="vendor_content")
    catalog_number: Optional[str] = Field(None, alias="catalog_number_content")
    catalog_webpage_url: Optional[str] = None
    citation: Optional[str] = Field(None, alias="citation_content")
    stage: Optional[str] = Field(None, alias="vhp4safety_workflow_stage_content")
    substage: Optional[str] = Field(None, alias="workflow_substage_content")
    case_study: Optional[str] = Field(None, alias="case_study_content")
    regulatory_question: Optional[str] = Field(
        None, alias="regulatory_question_content"
    )
    type_iri: Optional[str] = Field(None, alias="ontology_term_content")
    ontology: Optional[str] = Field(None, alias="type_content")
    ...
    aop_id: Optional[str] = Field(
        None,
        alias="relevant_aop_wiki_adverse_outcome_pathway(s)_to_the_assay_content",
    )
