...
function updateStep1Content() {
  ...
  document.getElementById("step1-content").innerHTML =
    `<h1 class="text-vhppink-distinct">${step1Contents.navTitle}</h1><p>${step1Contents.navDescription}</p>` +
...
function updateStep3Content() {
  ...
  if (step.steps) {
    document.getElementById("step3-content").innerHTML =
      `<h1 class="text-vhppink-distinct"><span class='kinetics-bold'>${step.navTitle}</span></h1><p class='step-desc'>${step.navDescription}</p>` +
